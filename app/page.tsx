  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-4 pt-20 pb-10">
        ...
        {/* Search Bar */}
        <form onSubmit={searchMovies} className="w-full max-w-2xl relative mb-16">
          <input 
        ...
        <div className="w-full max-w-7xl grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {movies.length > 0 ? (
            movies.map((movie) => (
                ...
                <div className="group bg-gray-900 rounded-2xl overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer h-full border border-gray-800 hover:border-blue-500/50 shadow-lg">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <span className="text-xs bg-gray-800 px-2 py-1 rounded text-gray-300 border border-gray-700">Movie</span>
                    </div>
                  </div>
                </div>
              </Link>
